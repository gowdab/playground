...
public class ClamAVClient {
    ...
    public boolean ping() throws IOException {
        ...
        try {
            socket = new Socket(clamAVProperties.getClamAvHost(), clamAVProperties.getClamAvPort());
